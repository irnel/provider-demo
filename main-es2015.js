...
let HomeAdminModule = class HomeAdminModule {
};
...
let AdminHeaderComponent = class AdminHeaderComponent {
    constructor(router, ngZone, authService, notification) {
        this.router = router;
        this.ngZone = ngZone;
...
let NavigationComponent = class NavigationComponent {
    constructor(router, breakpointObserver, authService) {
        this.router = router;
        this.breakpointObserver = breakpointObserver;
        this.authService = authService;
        this.isHandset$ = this.breakpointObserver.observe(_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_3__["Breakpoints"].Handset)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(result => result.matches));
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! angular-bootstrap-md */ "./node_modules/angular-bootstrap-md/fesm2015/angular-bootstrap-md.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
...
let HomeAdminWorkspaceComponent = class HomeAdminWorkspaceComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let StatsCard1Component = class StatsCard1Component {
    constructor() { }
    ngOnInit() {
    }
};
...
let UsersWorkspaceComponent = class UsersWorkspaceComponent {
    constructor(router, ngZone, userService, notification) {
        this.router = router;
        this.ngZone = ngZone;
...
UsersWorkspaceComponent.ctorParameters = () => [
...
let HomeCashierComponent = class HomeCashierComponent {
    constructor(breakPointObserver) {
        this.breakPointObserver = breakPointObserver;
        this.isHandSet$ = this.breakPointObserver.observe(_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_2__["Breakpoints"].Handset);
    }
...
HomeCashierComponent.ctorParameters = () => [
    { type: _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_2__["BreakpointObserver"] }
];
...
let HomeCashierModule = class HomeCashierModule {
};
...
let CashierHeaderComponent = class CashierHeaderComponent {
    constructor(router, ngZone, authService, notification) {
        this.router = router;
        this.ngZone = ngZone;
        this.authService = authService;
...
CashierHeaderComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["NgZone"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_3__["NotificationService"] }
...
let HomeCashierWorkspaceComponent = class HomeCashierWorkspaceComponent {
    constructor(router, route, ngZone, orderService, authService, dateService, notification) {
        this.router = router;
        this.route = route;
        this.ngZone = ngZone;
    ...
    ngOnInit() {
        ...
        this.subscription = this.dateService.currentDateSubject.subscribe(date => {
            !date
    ...
    getAllOrdersByDate(date) {
        ...
        this.observer$.subscribe(orders => {
            this.orders = orders;
            this.state = 'finished';
            // Filter orders by status
            this.ordersPending = this.orders.filter(order => order.status === _helpers__WEBPACK_IMPORTED_MODULE_6__["OrderState"].Pending);
            this.ordersReady = this.orders.filter(order => order.status === _helpers__WEBPACK_IMPORTED_MODULE_6__["OrderState"].Ready);
            this.ordersCompleted = this.orders.filter(order => order.status === _helpers__WEBPACK_IMPORTED_MODULE_6__["OrderState"].Completed);
            this.ordersCanceled = this.orders.filter(order => order.status === _helpers__WEBPACK_IMPORTED_MODULE_6__["OrderState"].Canceled);
            if (this.orderState === _helpers__WEBPACK_IMPORTED_MODULE_6__["OrderState"].All) {
                this.onClickAllOrders();
            }
            else if (this.orderState === _helpers__WEBPACK_IMPORTED_MODULE_6__["OrderState"].Pending) {
                this.onClickPendingOrders();
            }
            else if (this.orderState === _helpers__WEBPACK_IMPORTED_MODULE_6__["OrderState"].Ready) {
                this.onClickReadyOrders();
            }
            else if (this.orderState === _helpers__WEBPACK_IMPORTED_MODULE_6__["OrderState"].Completed) {
...
HomeCashierWorkspaceComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let HomeProviderComponent = class HomeProviderComponent {
    constructor(breakpointObserver) {
        this.breakpointObserver = breakpointObserver;
...
HomeProviderComponent.ctorParameters = () => [
...
let HomeProviderModule = class HomeProviderModule {
};
...
let ProviderHeaderComponent = class ProviderHeaderComponent {
    constructor(router, ngZone, authService, notification) {
        this.router = router;
        this.ngZone = ngZone;
        this.authService = authService;
...
ProviderHeaderComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["NgZone"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_3__["NotificationService"] }
...
let EditCashierWorkspaceComponent = class EditCashierWorkspaceComponent {
    constructor(router, route, formBuilder, ngZone, providerService, userService, authService, notification) {
        this.router = router;
        this.route = route;
    ...
    ngOnInit() {
        ...
        this.route.data.subscribe(data => {
            ...
            this.mode = data.mode;
            // Admin role
            if (this.userRole === _helpers__WEBPACK_IMPORTED_MODULE_7__["Roles"].Admin) {
            ...
            if (data.mode === 'edit') {
                ...
                this.providerService.getProviderById(this.providerId).subscribe(provider => this.provider = provider);
                // update form if mode is edit
                const cashierId = this.route.snapshot.params.cashierId;
                this.observer$ = this.userService.getUserById(cashierId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(cashier => {
                ...
                this.observer$ = this.providerService.getProviderById(this.providerId)
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(provider => {
        ...
        // validate name
        this.form.name.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(() => {
            let error = '';
        ...
        // validate email
        this.form.email.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(() => {
            let error = '';
    ...
    editCashier() {
        ...
        if (!this.edit) {
            ...
            this.authService.SignUp(cashier).then(() => {
                ...
                this.loading = false;
                this.notification.ErrorMessage(_helpers__WEBPACK_IMPORTED_MODULE_7__["FirebaseError"].Parse(error.code), '');
            });
        }
        else {
...
EditCashierWorkspaceComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
...
let EditCategoryWorkspaceComponent = class EditCategoryWorkspaceComponent {
    constructor(router, route, formBuilder, ngZone, notification, categoryService, providerService, authService, fileService) {
        this.router = router;
        this.route = route;
        this.formBuilder = formBuilder;
        this.ngZone = ngZone;
    ...
    ngOnInit() {
        ...
        this.route.data.subscribe(data => {
            ...
            this.mode = data.mode;
            // Admin role
            if (this.userRole === _helpers__WEBPACK_IMPORTED_MODULE_8__["Roles"].Admin) {
                this.userId = this.route.snapshot.params['userId'];
            }
            else {
                this.userId = this.authService.currentUserValue.uid;
            ...
            if (data.mode === 'create') {
                ...
                this.serverFiles$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["interval"])(1);
                this.observer$ = this.providerService.getProviderById(this.providerId);
                this.observer$.subscribe(provider => {
                    this.provider = provider;
                    this.state = 'finished';
                }, error => {
                    this.state = 'failed';
                ...
                this.observer$.subscribe(category => {
        ...
        // validate name
        this.form.name.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => {
            let error = '';
            if (this.form.name.hasError('required')) {
                error = 'name is required';
            }
    ...
    editCategory() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (!this.edit) {
                ...
                // create category
                yield this.categoryService.create(data).then((category) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    this.category = category;
                }))
                    .catch(error => {
                    this.notification.ErrorMessage(error.message, '', 2500);
...
EditCategoryWorkspaceComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
let EditProductWorkspaceComponent = class EditProductWorkspaceComponent {
    constructor(route, router, formBuilder, ngZone, categoryService, productService, notification, fileService) {
        this.route = route;
        this.router = router;
        this.formBuilder = formBuilder;
        this.ngZone = ngZone;
    ...
    ngOnInit() {
        ...
        this.route.data.subscribe(data => {
            ...
            if (data.mode === 'create') {
                ...
                // initialize observable with interval
                this.serverFiles$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["interval"])(1);
                ...
                this.categoryService.getCategoryData(this.providerId, this.categoryId).subscribe(category => this.category = category);
                this.observer$ = this.productService.getProductData(this.providerId, this.categoryId, productId);
                this.observer$.subscribe(product => {
        ...
        // validate price
        this.form.price.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(() => {
            let error = '';
    ...
    editProduct() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (!this.edit) {
                ...
                // create product
                yield this.productService.create(data).then((product) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    this.product = product;
                })).catch(error => {
                    this.notification.ErrorMessage(error.message, '', 2500);
                    this.loading = false;
...
EditProductWorkspaceComponent.ctorParameters = () => [
...
let EditProviderWorkspaceComponent = class EditProviderWorkspaceComponent {
    constructor(router, route, ngZone, formBuilder, mapsAPILoader, authService, providerService, fileService, notification, document) {
        this.router = router;
        this.route = route;
        this.ngZone = ngZone;
        this.formBuilder = formBuilder;
    ...
    ngOnInit() {
        ...
        this.route.data.subscribe(data => {
            ...
            if (data.mode === 'create') {
                ...
                this.observer$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["interval"])(1);
                this.serverFiles$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["interval"])(1);
                // google maps values
                this.zoom = 4;
                this.address = {
        ...
        // validate Address
        this.form.address.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => {
            let error = '';
    ...
    editProvider() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (!this.edit) {
                ...
                // create provider
                yield this.providerService.create(data).then((provider) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    this.provider = provider;
                }))
                    .catch(error => {
...
EditProviderWorkspaceComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
let GalleryComponent = class GalleryComponent {
    constructor(route, fileService, notification) {
        this.route = route;
        this.fileService = fileService;
        this.notification = notification;
    ...
    onSelectFile(event) {
        ...
        for (const file of event.target.files) {
            ...
            reader.addEventListener('load', (eventProgress) => {
...
let HomeWorkspaceComponent = class HomeWorkspaceComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let StatsCardComponent = class StatsCardComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let BasicTableComponent = class BasicTableComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CashierWorkspaceComponent = class CashierWorkspaceComponent {
    constructor(route, router, ngZone, userService, providerService, notification) {
        this.route = route;
        this.router = router;
        this.ngZone = ngZone;
        this.userService = userService;
    ...
    ngOnInit() {
        ...
        this.observer$.subscribe(cashiers => {
            this.cashiers = cashiers;
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](cashiers);
            this.dataSource.paginator = this.paginator;
            this.dataSource.sort = this.sort;
            this.state = 'finished';
        }, error => {
...
CashierWorkspaceComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["NgZone"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_6__["UserService"] },
...
let CategoryDetailsWorkspaceComponent = class CategoryDetailsWorkspaceComponent {
    constructor(route, router, ngZone, categoryService, userService, notification) {
        this.route = route;
        this.router = router;
        this.ngZone = ngZone;
        this.categoryService = categoryService;
    ...
    redirectToProductWorkspace() {
        this.ngZone.run(() => {
            ...
            // Provider role
            if (this.userRole === _helpers__WEBPACK_IMPORTED_MODULE_4__["Roles"].Provider) {
...
CategoryDetailsWorkspaceComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"] },
...
let CategoryWorkspaceComponent = class CategoryWorkspaceComponent {
    constructor(route, router, ngZone, providerService, categoryService, userService, notification) {
        this.route = route;
        this.router = router;
        this.ngZone = ngZone;
        this.providerService = providerService;
    ...
    ngOnInit() {
        ...
        this.observer$.subscribe(categories => {
    ...
    redirectToCategoryDetails(catId) {
        this.ngZone.run(() => {
            let url = '';
            // Admin role
            if (this.userRole === src_app_helpers__WEBPACK_IMPORTED_MODULE_6__["Roles"].Admin) {
            ...
            // Provider role
            if (this.userRole === src_app_helpers__WEBPACK_IMPORTED_MODULE_6__["Roles"].Provider) {
...
CategoryWorkspaceComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["NgZone"] },
...
let HeaderComponent = class HeaderComponent {
    ...
    SignOut() {
        this.authService.SignOut().then(() => {
            ...
            .catch(error => {
            this.notification.ErrorMessage(_helpers_firebase_error__WEBPACK_IMPORTED_MODULE_4__["FirebaseError"].Parse(error.code), '');
        });
    }
};
...
let OrderDetailsWorkspaceComponent = class OrderDetailsWorkspaceComponent {
    constructor(route, router, ngZone, orderService, dateService, userService, notification) {
        this.route = route;
        this.router = router;
        this.ngZone = ngZone;
        this.orderService = orderService;
    ...
    updateOrderStatus(value) {
        ...
        this.orderService.update(this.order, this.date).then(() => this.notification.SuccessMessage(`Status changed to ${this.order.status}`, '', 2500)).catch(error => {
            this.notification.ErrorMessage(error.message, '', 2500);
        });
    }
...
OrderDetailsWorkspaceComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"] },
...
let OrderWorkspaceComponent = class OrderWorkspaceComponent {
    constructor(route, router, ngZone, orderService, providerService, userService, dateService, notification) {
        this.route = route;
        this.router = router;
        this.ngZone = ngZone;
        this.orderService = orderService;
    ...
    ngOnInit() {
        ...
        this.providerId = this.route.snapshot.params['providerId'];
        this.observer$ = this.providerService.getProviderById(this.providerId);
        this.observer$.subscribe(provider => this.provider = provider);
    ...
    getAllOrdersByDate(date) {
        ...
        this.observer$.subscribe(orders => {
            this.orders = orders;
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.orders);
            this.dataSource.paginator = this.paginator;
            this.dataSource.sort = this.sort;
            this.state = 'finished';
        }, error => {
...
OrderWorkspaceComponent.ctorParameters = () => [
...
let ProductDetailsWorkspaceComponent = class ProductDetailsWorkspaceComponent {
    constructor(route, router, ngZone, productService, userService, notification) {
        this.route = route;
        this.router = router;
        this.ngZone = ngZone;
        this.productService = productService;
...
ProductDetailsWorkspaceComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"] },
...
let ProductWorkspaceComponent = class ProductWorkspaceComponent {
    constructor(route, router, ngZone, productService, categoryService, userService, notification) {
        this.route = route;
        this.router = router;
        this.ngZone = ngZone;
        this.productService = productService;
    ...
    ngOnInit() {
        ...
        this.observer$.subscribe(products => {
...
ProductWorkspaceComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"] },
...
let ProviderDetailsWorkspaceComponent = class ProviderDetailsWorkspaceComponent {
    constructor(router, route, ngZone, providerService, userService, notification) {
        this.router = router;
        this.route = route;
        this.ngZone = ngZone;
        this.providerService = providerService;
...
ProviderDetailsWorkspaceComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"] },
...
let ProviderWorkspaceComponent = class ProviderWorkspaceComponent {
    constructor(ngZone, router, route, authService, userService, providerService, notification) {
        this.ngZone = ngZone;
        this.router = router;
        this.route = route;
        this.authService = authService;
    ...
    ngOnInit() {
        ...
        this.observer$.subscribe(providers => {
            this.providers = providers;
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](providers);
            this.dataSource.paginator = this.paginator;
            this.dataSource.sort = this.sort;
            this.state = 'finished';
        }, error => {
    ...
    redirectToProviderDetails(providerId) {
        this.ngZone.run(() => {
            let url = '';
            // Admin Role
            if (this.userRole === _helpers__WEBPACK_IMPORTED_MODULE_6__["Roles"].Admin) {
...
ProviderWorkspaceComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["NgZone"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
...
let IntialComponent = class IntialComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let LoginComponent = class LoginComponent {
    constructor(router, ngZone, render, formBuilder, route, authService, notification) {
        this.router = router;
        this.ngZone = ngZone;
        this.render = render;
        this.formBuilder = formBuilder;
    ...
    ngOnInit() {
        ...
        // validate email
        this.form.email.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(() => {
            let error = '';
            if (this.form.email.hasError('required')) {
                error = 'email is required';
            }
        ...
        this.formReset.resetEmail.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(() => {
            let error = '';
    ...
    login() {
        ...
        this.authService.SignIn(this.form.email.value, this.form.password.value)
            ...
            this.loading = false;
            this.clicked = false;
            this.notification.ErrorMessage(_helpers__WEBPACK_IMPORTED_MODULE_6__["FirebaseError"].Parse(error.code), '', 2500);
        });
    }
    loginWithGoogle() {
        this.clicked = true;
    ...
    forgotPassword() {
        ...
        this.authService.SendPasswordResetEmail(email).then(() => {
            ...
            this.notification.SuccessMessage(`forgot password sent email to ${email}`, '', 2500);
        })
            .catch(error => {
            this.notification.ErrorMessage(_helpers__WEBPACK_IMPORTED_MODULE_6__["FirebaseError"].Parse(error.code), '', 2500);
        });
    ...
    sendVerificationMail() {
        ...
        this.authService.SendVerificationMail().then(() => {
            ...
            this.notification.SuccessMessage(`Verification email sent to ${this.form.email.value}`, '');
        })
            .catch(error => {
            this.notification.ErrorMessage(_helpers__WEBPACK_IMPORTED_MODULE_6__["FirebaseError"].Parse(error.code), '', 2500);
        });
...
let RegisterComponent = class RegisterComponent {
    constructor(router, render, formBuilder, authService, notificationService) {
        this.router = router;
        this.render = render;
        this.formBuilder = formBuilder;
        this.authService = authService;
    ...
    ngOnInit() {
        ...
        // validate Full Name
        this.form.fullName.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(() => {
            let error = '';
    ...
    createAccount() {
        ...
        this.authService.SignUp(data).then(user => {
            ...
            .catch(error => {
            this.loading = false;
            this.notificationService.ErrorMessage(_helpers__WEBPACK_IMPORTED_MODULE_7__["FirebaseError"].Parse(error.code), '');
        });
    }
    sendVerificationMail() {
        this.authService.SendVerificationMail().then(() => {
            this.hideModal();
            this.notificationService.SuccessMessage(`Verification email sent to ${this.email}`, '');
        })
            .catch(error => {
            this.notificationService.ErrorMessage(_helpers__WEBPACK_IMPORTED_MODULE_7__["FirebaseError"].Parse(error.code), '');
        });
...
let AuthService = class AuthService {
    constructor(afAuth, afs, userService, notificationService) {
        this.afAuth = afAuth;
        this.afs = afs;
        this.userService = userService;
        this.notificationService = notificationService;
       ...
       logged in and setting up null when logged out */
        this.afAuth.authState.subscribe(firebaseUser => {
            if (firebaseUser) {
                ...
                this.userService.getUserById(firebaseUser.uid).subscribe(user => {
    ...
    GoogleAuth() {
        ...
        const googleProvider = new firebase__WEBPACK_IMPORTED_MODULE_5__["auth"].GoogleAuthProvider();
    ...
    get isAdmin() {
        const index = this.currentUserValue.roles.findIndex(role => role === _helpers_enum_roles__WEBPACK_IMPORTED_MODULE_8__["Roles"].Admin);
        return index !== -1;
    }
...
let CashierService = class CashierService {
    ...
    getAllCashiersByProviderId(providerId) {
        ...
        return collection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => actions.map(action => {
            const cashier = action.payload.doc.data();
    ...
    getCashierData(providerId, cashierId) {
        ...
        return cashierDoc.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(snapshot => {
            const cashier = snapshot.payload.data();
    ...
    create(cashier) {
        ...
        return collection.add(cashier).then(docRef => {
            return docRef.get().then(snapshot => {
                const cashierDoc = snapshot.data();
...
let CategoryService = class CategoryService {
    ...
    getAllCategoriesByProviderId(providerId) {
        ...
        return collection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => actions.map(action => {
            const category = action.payload.doc.data();
    ...
    getCategoryData(providerId, categoryId) {
        ...
        return categoryDoc.get().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(snapshot => {
    ...
    create(category) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            return yield collection.add(category).then((docRef) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                return yield docRef.get().then((snapshot) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    const categoryDoc = snapshot.data();
...
let FileService = class FileService {
    ...
    upload(filesInfo, model) {
                    ...
                    return this.afs.collection(docFileRef).add({
                        ...
                        if (fileInfo.markAsPrincipal) {
                            ...
                            switch (fileInfo.modelType) {
                                ...
                                case 'products': {
                                    docRef = this.afs.doc(`products/${model.providerId}/list/${model.categoryId}/list/${model.id}`);
                                    break;
                                }
                                default:
                                    break;
        ...
        // All percentages
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["combineLatest"])(totalPercentage).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(percentages => {
            let result = 0;
    ...
    getAllFilesInfoByModelId(modelId) {
        ...
        return collection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(actions => actions.map(action => {
            const file = action.payload.doc.data();
            file.id = action.payload.doc.id;
            return file;
        })));
    }
    updateFileInfo(file, model) {
        let modelDoc;
        ...
        collectionRef.get().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(query => query.docs.map(doc => {
            if (doc.exists) {
...
let NotificationService = class NotificationService {
    ...
    InfoMessage(message, title, timeOut) {
        this.toast.info(message, title);
    }
    SuccessMessage(body, title, timeOut) {
        this.toast.success(body, title);
    }
    ErrorMessage(body, title, timeOut) {
        this.toast.error(body, title);
    }
    WarningMessage(body, title, timeOut) {
...
let OrderService = class OrderService {
    ...
    getAllOrdersByProviderId(providerId, date) {
        const collection = this.afs.collection(`orders/${providerId}/${date.getFullYear()}/${date.getMonth()}/${date.getDate()}`, query => query.orderBy('pickupTime'));
        // const collection = this.afs.collection(
        //     `orders/${providerId}/2019/4/9`,
        //     query => query.orderBy('pickupTime')
        // );
        return collection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => actions.map(action => {
            const order = action.payload.doc.data();
            order.id = action.payload.doc.id;
            return order;
        })));
    }
    getOrderData(providerId, orderId, date) {
        const orderDoc = this.afs.doc(`orders/${providerId}/${date.getFullYear()}/${date.getMonth()}/${date.getDate()}/${orderId}`);
        return orderDoc.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(snapshot => {
            const order = snapshot.payload.data();
            order.id = snapshot.payload.id;
            return order;
        }));
    }
    update(order, date) {
        const orderDoc = this.afs.doc(`orders/${order.providerId}/${date.getFullYear()}/${date.getMonth()}/${date.getDate()}/${order.id}`);
...
let ProductService = class ProductService {
    ...
    getProductData(providerId, categoryId, productId) {
        const productDoc = this.afs.doc(`products/${providerId}/list/${categoryId}/list/${productId}`);
        return productDoc.snapshotChanges()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(snapshot => {
            const product = snapshot.payload.data();
    ...
    create(product) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const collection = this.afs.collection(`products/${product.providerId}/list/${product.categoryId}/list`);
            return yield collection.add(product).then((docRef) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                return yield docRef.get().then((snapshot) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    const productDoc = snapshot.data();
    ...
    update(product) {
        const productDoc = this.afs.doc(`products/${product.providerId}/list/${product.categoryId}/list/${product.id}`);
...
let ProviderService = class ProviderService {
    ...
    getAllProviderByUserId(userId) {
        const collection = this.afs.collection('providers', query => query.where('userId', '==', userId));
        return collection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(actions => actions.map(action => {
            const provider = action.payload.doc.data();
    ...
    getProviderById(providerId) {
        return this.providerCollection.doc(providerId).snapshotChanges()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(snapshot => {
            const provider = snapshot.payload.data();
    ...
    create(provider) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return yield this.providerCollection.add(provider).then((docRef) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                return yield docRef.get().then((snapshot) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    const providerDoc = snapshot.data();
...
let UserService = class UserService {
    ...
    getAllUsers() {
        return this.usersCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => actions.map(a => {
    ...
    getAllUsersByType(type) {
        const collection = this.af.collection('users', query => query.where('roles', 'array-contains', type));
        return collection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => actions.map(action => {
            const user = action.payload.doc.data();
            user.uid = action.payload.doc.id;
            return user;
        })));
    }
    getAllUsersByParentId(parentId) {
        const collection = this.af.collection('users', query => query.where('parentId', '==', parentId));
        return collection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => actions.map(action => {
            const user = action.payload.doc.data();
            user.uid = action.payload.doc.id;
            return user;
    ...
    getUserById(uid) {
        return this.af.doc(`users/${uid}`).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(snapshot => {
            const user = snapshot.payload.data();
            user.uid = snapshot.payload.id;
            return user;
        }));
    }
    getUserByEmail(email) {
        const collection = this.af.collection('users', query => query.where('email', '==', email).limit(1));
        return collection.get().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(query => query.docs.map(doc => {
            const user = doc.data();
            user.uid = doc.id;
            return user;
        })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(users => users.length > 0 ? users[0] : null));
    }
    isEmailTaken(email) {
        return this.getUserByEmail(email).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(user => user ? true : false));
    }
    getUserWithEmailAndPassword(email, password) {
        const collection = this.af.collection('users', query => query.where('email', '==', email)
